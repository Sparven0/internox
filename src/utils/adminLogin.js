...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, user_name, password, result, user, passwordMatch, token, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, masterpool_1.default.query("SELECT db_name FROM companies WHERE user_name = $1 AND role = 'admin'", [user_name])];
                case 1:
                    result = _b.sent();
